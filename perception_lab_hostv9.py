#!/usr/bin/env python3
"""
Antti's Perception Laboratory - Host v9.0 (Speed Control & State Persistence)
-----------------------------------------------------------------
...
class PerceptionLab(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Antti's Perception Laboratory v9 - Speed Control Edition 🚀")
        ...
        version_label = QtWidgets.QLabel("v9 - Speed Control Edition 🚀")
