#!/usr/bin/env python3
"""
Antti's Perception Laboratory - Host v6.1 (Neuroplasticity Enabled)
-----------------------------------------------------------------
[V6.1 FEATURE] Added 'learned_weight' support to EdgeItem. 
               The physics engine now multiplies signal transfer by this weight.
               This enables the SystemOptimizer to actually alter logic flow.
[V6 CORE] Maximized compatibility with old nodes.
